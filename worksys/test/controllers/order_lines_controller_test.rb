...
class OrderLinesControllerTest < ActionController::TestCase
  ...
  test "should create order_line" do
    assert_difference('OrderLine.count') do
      post :create, order_line: { price: @order_line.price, quantity: @order_line.quantity, sum: @order_line.sum, title: @order_line.title }
    end
  ...
  test "should update order_line" do
    patch :update, id: @order_line, order_line: { price: @order_line.price, quantity: @order_line.quantity, sum: @order_line.sum, title: @order_line.title }
    assert_redirected_to order_line_path(assigns(:order_line))
  end
