...
RSpec.describe "homyproducts/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit homyproduct form" do
    render

    assert_select "form[action=?][method=?]", homyproduct_path(@homyproduct), "post" do
